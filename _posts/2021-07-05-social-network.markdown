...
После того как я почти закончил выполнять личный дипломный проект по курсу. Мне предложили получить командный диплом.
Где в команде нужно было разрабатывать социальную сеть, ну я и согласился. Как-никак это опыт. После того как команда
