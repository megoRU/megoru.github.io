...
import videoMp4 from './diploma-defense.mp4'
...
![social-network-friends](./social-network-friends.png)

Уведомления

![social-network-netification](./social-network-netification.jpg)
...
<ReactPlayer playing controls src={videoMp4}/>