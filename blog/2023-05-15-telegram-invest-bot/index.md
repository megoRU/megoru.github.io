...
![invest-account](./invest-account.PNG)

Подписки на акции и не только.

![invest-subscribers](./invest-subscribers.PNG)

Настройки объёмов.

![invest-volume-settings](./invest-volume-settings.PNG)

Уведомления о достижении цены акции.

![invest-price-notice](./invest-price-notice.jpg)
